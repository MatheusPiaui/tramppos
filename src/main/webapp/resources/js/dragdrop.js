...
//        self.fileArea.appendChild(img);
        ...
        inputImg.setAttribute("width","313");
        inputImg.setAttribute("height","240");
        inputImg.setAttribute("src",f.target.result);

        self.fileArea.appendChild(inputImg);
