package com.tramppos.webService;
...
/* M�todos e variaveis estaticas, responsaveis pela busca do CEP */
    /**
     * Mascara para a string url de conexao, onde <tt>"%s"</tt> � substituido pelo valor
     * do cep. 
     */
